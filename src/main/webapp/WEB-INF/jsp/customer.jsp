...
<%@taglib prefix="njpi" uri="http://edu.njpi.com/common" %>
<%
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="col-md-12 text-right">
                        <njpi:page url="${pageContext.request.contextPath }/customer/list.action" />
                    </div>
                    <!-- /.panel-body -->
                </div>
                <!-- /.panel -->
...
<script type="text/javascript">
    ...
    function updateCustomer() {
        console.log($("#edit_customer_form").serialize())
